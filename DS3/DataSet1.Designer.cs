...
namespace DS3.DataSet1TableAdapters {
    ...
    public partial class DepartmentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DS3.Properties.Settings.Default.ypConnectionString;
        }
...
SELECT id_employee, name_emp, surname_emp, midlname_emp, position_id, hire_date, salary FROM Employees WHERE (id_employee = @id_employee)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = @"SELECT name_emp, surname_emp, midlname_emp, hire_date, Positions.title, Departments.name_dep, salary 
FROM dbo.Employees
 inner join dbo.Positions on position_id = Positions.id_position
 inner join dbo.Departments on Positions.department_id = Departments.id_department";
        ...
        public virtual DataSet1.EmployeesDataTable GetDataView() {
